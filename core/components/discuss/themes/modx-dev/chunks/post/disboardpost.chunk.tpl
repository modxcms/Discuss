<div class="row l-table h-group dis-category-[[+category]] [[+class]] [[+locked:is=`1`:then=`locked`:else=`unlocked`]] [[+unreadCls]]">
   <a class="h-group" href="[[+url]]">
        ...
        <div class="f10-f12">
            <p class="posted-by">[[%discuss.board_by]]: [[+first_post_username]], [[+first_post_createdon:ago]]</p>
            <p class="posted-by">[[%discuss.board_last]]: [[+last_post_username]], [[+createdon:ago]]</p>
        </div>
    </a>
</div>
