...
class DiscussThreadNoRepliesController extends DiscussThreadUnreadController {
    ...
    public function getBreadcrumbs() {
        ...
        $trail[] = array('text' => $this->modx->lexicon('discuss.threads_no_replies').' ('.number_format($this->threads['total']).')','active' => true);
        return $trail;
    }
