 ...
 */
class DiscussThreadSpamController extends DiscussController {
    /** @var disThread $thread */
    public $thread;

    public function getPageTitle() {
        return $this->modx->lexicon('discuss.spam_thread_header',array('title' => $this->thread->get('title')));
    }
