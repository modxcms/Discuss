 ...
 */
class DiscussMgrBoardUpdateManagerController extends DiscussManagerController {
    /** @var disBoard $board */
    public $board;
    ...
    public function loadCustomCssJs() {
        ...
        $this->addLastJavascript($this->discuss->config['mgrJsUrl'].'sections/board/update.js');
    }
    public function getTemplateFile() { return $this->discuss->config['templatesPath'].'board/update.tpl'; }
}