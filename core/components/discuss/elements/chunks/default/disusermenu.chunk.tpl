<p class="dis-breadcrumbs">
    <a href="[[~[[++discuss.board_list_resource]]]]">[[++discuss.forum_title]]</a> / [[%discuss.profile]]
</p>
...
<div class="dis-menu left" style="padding-right: 10px; width: 18%;">
    ...
    <ul>
        ...
        <li><a href="[[~[[++discuss.user_notifications_resource]]? &user=`[[+id]]`]]">[[%discuss.notifications]]</a></li>
