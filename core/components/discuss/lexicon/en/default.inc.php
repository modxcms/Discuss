...
$_lang['discuss.user.one_new_post'] = 'one new post';
$_lang['discuss.user.new_posts'] = '[[+total]] new posts';
$_lang['discuss.user.no_new_messages'] = 'no unread messages';
$_lang['discuss.user.one_new_message'] = 'one unread message';
$_lang['discuss.user.new_messages'] = '[[+total]] unread messages';
$_lang['discuss.user.no_new_replies'] = 'no replies';
$_lang['discuss.user.one_new_reply'] = 'one reply';
$_lang['discuss.user.new_replies'] = '[[+total]] unread replies';
$_lang['discuss.user.no_unanswered_questions'] = 'no unanswered questions';
$_lang['discuss.user.one_unanswered_questions'] = 'one unanswered question';
$_lang['discuss.user.new_unanswered_questions'] = '[[+total]] unanswered questions';
$_lang['discuss.user.no_no_replies'] = 'no threads without replies';
$_lang['discuss.user.one_no_reply'] = 'one thread without reply';
$_lang['discuss.user.no_replies'] = '[[+total]] threads without replies';
